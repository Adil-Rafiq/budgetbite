import { useCreatePlanContext } from '@/app/(app)/plans/_context/create-plan-context';
...
export const StepNotifications = () => {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="overflow-hidden rounded-xl border border-sand bg-surface">
            ...
            >
              <div className="flex items-center justify-between gap-3">
                ...
                >
                  <span
                    aria-hidden
                    className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-teal/10 text-[11px] font-semibold text-teal-ink"
                  >
                  ...
                  <button
                    ...
                    className={`min-h-11 rounded-full px-3 text-[10px] font-semibold tracking-[0.1em] transition active:scale-[0.96] ${FOCUS_RING} ${
                      slot.enabled
                        ...
                        : 'border border-sand bg-surface text-slate/60 hover:border-teal/40 hover:text-slate'
                    }`}
                  >
                    {slot.enabled ? 'ON' : 'OFF'}
                  </button>
