      ...
      <div className="mt-auto flex flex-col gap-2 pt-4">
        ...
        <div className="flex items-end justify-between gap-2">
          <div className="flex flex-col gap-1">
            <div className="h-2.5 w-16 animate-pulse rounded bg-sage" />
            <div className="h-5 w-20 animate-pulse rounded bg-sage" />
            <div className="h-2.5 w-24 animate-pulse rounded bg-sage" />
          </div>
