...
import { UtensilsCrossed, MapPin, Wallet, Bell, ArrowRight, ArrowLeft, Plus, X } from "lucide-react"
...
const steps = [
  { icon: MapPin, title: "Set your location", description: "We use this to find nearby restaurants" },
...
export default function OnboardingPage() {
  ...
  const addNotificationTime = () => {
    setNotificationTimes((prev) => [...prev, "12:00"])
  }
            ...
            {currentStep === 0 && (
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <Input id="latitude" type="number" placeholder="24.8607" defaultValue="24.8607" step="0.0001" />
                </div>
                <div className="flex flex-col gap-2">
                  <Label htmlFor="longitude">Longitude</Label>
                  <Input id="longitude" type="number" placeholder="67.0011" defaultValue="67.0011" step="0.0001" />
                </div>
