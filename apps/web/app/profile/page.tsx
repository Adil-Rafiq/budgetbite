...
import { DietaryCard } from '@/app/profile/_components/dietary-card';
import { FoodPreferencesCard } from '@/app/profile/_components/food-preferences-card';
import { LocationCard } from '@/app/profile/_components/location-card';
import { NotificationTimesCard } from '@/app/profile/_components/notification-times-card';
import { PasswordCard } from '@/app/profile/_components/password-card';
import { PersonalCard } from '@/app/profile/_components/personal-card';
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              className={`min-h-11 rounded-xl bg-tomato-ink px-5 text-[13px] font-semibold text-white transition-colors hover:bg-tomato-ink/90 active:scale-[0.97] ${FOCUS_RING_ON_CANVAS}`}
            >
              Discard and leave
            </AlertDialogAction>
          </AlertDialogFooter>
