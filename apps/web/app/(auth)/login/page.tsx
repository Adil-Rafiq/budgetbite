      ...
      <main className="relative z-10 mx-auto flex min-h-[calc(100vh-100px)] w-full max-w-[440px] flex-col justify-center px-6 pb-16">
        <div className="text-center">
          ...
          <p className="mt-3 text-[15px] leading-[1.55]" style={{ color: MUTED }}>
            Sign in to plan this week of dinners.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="mt-1 inline-flex w-full items-center justify-center gap-2 rounded-full px-6 py-3 text-[14px] font-medium transition disabled:opacity-60"
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border px-4 py-2.5 text-[13px] font-medium"
              style={{ borderColor: LUMEN_DK, color: VAST, background: WHITE }}
            >
