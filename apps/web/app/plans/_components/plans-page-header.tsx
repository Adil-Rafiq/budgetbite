...
import { useNewPlanLauncher } from '@/app/plans/_context/new-plan-launcher';
  ...
  return (
    <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
      ...
      <button
        ...
        className={`inline-flex min-h-11 shrink-0 items-center justify-center gap-2 self-start rounded-xl bg-green px-5 text-sm font-semibold text-white shadow-md transition-colors hover:bg-dark-green sm:self-auto ${FOCUS_RING_ON_CANVAS}`}
      >
        New plan
